...
def get_polaris_configs():
    ...
    from fla.training.config import AssetsConfig
    from fla.training.config import RLDSDroidDataConfig
    from fla.training.config import SimpleDataConfig
    ...
    return [
        ...
        # fla doesn't support finetuning of binning policies, so this is an inference-only config
        TrainConfig(
